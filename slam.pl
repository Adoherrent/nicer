...
my ($iaddr,$endtime,$psize,$pport,$hexed,$hexed1,$hexed2,$hexed3,$hexed4);)
...
$psize = $size ? $size : int(rand	$hexed = $hex[rand @hex];
	$hexed1 = $hex[rand @hex];
	$hexed2 = $hex[rand @hex];
	$hexed3 = $hex[rand @hex];
	$hexed4 = $hex[rand @hex];
